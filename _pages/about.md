...
- Evaporation-driven flows in multicomponent droplets
- Marangoni instabilities and interfacial phenomena
- Finite element methods for multi-physics problems
- Computational fluid dynamics at the microscale
- Numerical framework development

## News

- **2026** — New paper published in *Soft Matter*: upstream motion of oil droplets in co-axial Ouzo flow
- **2026** — New paper published in *Journal of Fluid Mechanics*: internal flow in neighbouring evaporating binary droplets
- **2025** — Two first-author papers published in *Journal of Fluid Mechanics* on Marangoni flows in evaporating sessile droplets
- **2025** — Paper published in *Advanced Science* on symmetry breaking in chemical systems
- **2024** — Paper on bifurcation tracking published in *Journal of Computational Physics*
